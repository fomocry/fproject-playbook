...
L'extension Chrome F Project amène l'exécution directement dans ton navigateur. Le principe : l'information circule sur X, Discord et les pages token — l'extension supprime toutes les étapes entre le moment où tu vois un token et le moment où tu es en position.
...
> 💡 L'extension ne remplace pas le bot — elle le complète. La config fine de tes ruggers (TP/SL, protection, buy modes) reste sur le bot. L'extension, c'est ton poste d'exécution rapide pendant que tu navigues.
...
Une fois connecté, l'extension charge automatiquement tes wallets, tes presets et tes trackers.
