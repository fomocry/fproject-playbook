...
**Solution** : Relancez la transaction. Si le problème persiste, essayez d'augmenter le Bribe dans les gas fees pour obtenir une meilleure priorité.
...
**Solution** : Envoyez du SOL sur votre wallet. N'oubliez pas que chaque transaction nécessite environ 0.012 SOL de gas fees en plus du montant d'achat.
